...
parser.add_argument('--infolder', help='input folder [def="SB_merged"]',default='.')
parser.add_argument('--out', help='output file [def="shortbred_merged.csv"]',default='shortbred_merged.csv')
...
print ('> doing 1st pass: finding all markers')
c = 0
for i in os.listdir(inFolder):
   if '_sb.txt' not in inFolder+'/'+i: continue
