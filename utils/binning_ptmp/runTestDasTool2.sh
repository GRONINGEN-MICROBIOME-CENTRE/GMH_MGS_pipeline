#!/bin/bash
#SBATCH --job-name=jDAS_v2
#SBATCH --error=JOB_OUT/__binning_DAS_v2.err
#SBATCH --output=JOB_OUT/__binning_DAS_v2.out
#SBATCH --mem=4gb
...
#  >> 1) MetaWrap
echo "  >>> parsing MetaWrap"
NFA=0
BDIR=bins_metawrap_refined
if [ -d ${BDIR} ] 
then
