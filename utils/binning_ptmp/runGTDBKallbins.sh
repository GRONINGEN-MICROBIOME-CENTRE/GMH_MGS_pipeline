...
#SBATCH --error=JOB_OUT/__gtdbk_allbinners.err
#SBATCH --output=JOB_OUT/__gtdbk_allbinners.out
#SBATCH --mem=64gb
...
# --- load DB ---
export GTDBTK_DATA_PATH=/scratch/umcg-rgacesa/DB_GTDB/release207_v2
echo "  >> Database set to ${GTDBTK_DATA_PATH}"
# --- LOAD MODULES ---
...
echo " > LOOKING FOR BINS ..."
#  >> 1) CONCOCT
runGTDBK "bins_concoct"
#  >> 2) METABAT2
runGTDBK "bins_metabat2"
#  >> 3) MAXBIN2
runGTDBK "bins_maxbin2"
#  >> 4) VAMB
runGTDBK "bins_vamb"
#  >> 5) SEMIBIN
runGTDBK "bins_semibin"
#  >> 6) METAWRAP
runGTDBK "bins_metawrap_refined"
#  >> 7) metaCOAG
runGTDBK "bins_metaCOAG"
#  >> 8) graphBin
runGTDBK "bins_graphBin"
#  >> 9) DAS TOOL
runGTDBK "bins_DAS"
#  >> 10) Reassembled_bins
runGTDBK "bins_reassembled"
# >> DONE <<
echo " > ALL DONE! "
