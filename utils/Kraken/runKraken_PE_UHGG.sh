...
kraken2 --paired --db $DB --threads 1 --output - --classified-out $OUTSCLASS --unclassified-out $OUTSUNCLASS --report ${SNAME}/kraken2/${SNAME}.kreport --minimum-hit-groups $MINHIT --confidence $CONF $1 $2
